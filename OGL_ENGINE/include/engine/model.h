...
public:
    ...
    void setRotation(vec3 axisRotation, float angle)
    {
        this->angle = angle;
        this->rotationAxis = axisRotation;
        collbox.setAngle(angle);
    ...
    void drawCollBox(glm::mat4 view, glm::mat4 projection)
    {
        collbox.draw(view, projection);
    }
...
private:
    ...
    Mesh processMesh(aiMesh *mesh, const aiScene *scene)
    {
        ...
        //SI NO ENCUENTRA TEXTURAS CARGA LOS COLORES DE LOS MATERIALES
        ...
        try
        {
            if (material->GetTextureCount(aiTextureType_DIFFUSE) <= 0)
            {
                ...
                Texture t;
                t.color = glm::vec4(color.r, color.g, color.b, opacity);
        ...
        return Mesh(vertices, indices, textures, normals, notMaterials);
    }
